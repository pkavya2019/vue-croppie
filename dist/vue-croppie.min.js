! function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(e.VueCroppie = {})
}(this, function(e) {
    "use strict";
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
    var i, n = (function(e, i) {
            var n, o;
            n = "undefined" != typeof self ? self : t, o = function() {
                "function" != typeof Promise && function(t) {
                    ...
                    function n(e) {
                        ...
                        this._state = null, this._value = null, this._deferreds = [], h(e, i(r, this), i(a, this))
                    }
                    ...
                    function r(e) {
                        try {
                            ...
                            if (e && ("object" == typeof e || "function" == typeof e)) {
                                var t = e.then;
                                if ("function" == typeof t) return void h(i(t, e), i(r, this), i(a, this))
                            }
                    ...
                    n.prototype.catch = function(e) {
                        ...
                        c = e
                    }, e.exports ? e.exports = n : t.Promise || (t.Promise = n)
                ...
                function h(e, t) {
                    for (var i in e = e || {}, t) t[i] && t[i].constructor && t[i].constructor === Object ? (e[i] = e[i] || {}, h(e[i], t[i])) : e[i] = t[i];
                    return e
                }
                ...
                w.parse = function(e) {
                    ...
                    var t = e.split(") "),
                        i = t[0].substring(D.globals.translate.length + 1).split(","),
                        n = t.length > 1 ? t[1].substring(6) : 1,
                        o = i.length > 1 ? i[0] : 0,
                        r = i.length > 1 ? i[1] : 0;
                    return new w(o, r, n)
                }, w.prototype.toString = function() {
                    var e = g[D.globals.translate].suffix || "";
                    return D.globals.translate + "(" + this.x + "px, " + this.y + "px" + e + ") scale(" + this.scale + ")"
                };
                var y = function(e) {
                ...
                function b(e) {
                    return e.exifdata && e.exifdata.Orientation ? f(e.exifdata.Orientation) : 1
                }
                ...
                function C() {
                    var e, o, r, a, s, l, h = this.options.viewport.type ? "cr-vp-" + this.options.viewport.type : null;
                    this.options.useCanvas = this.options.enableOrientation || E.call(this), this.data = {}, this.elements = {}, e = this.elements.boundary = document.createElement("div"), r = this.elements.viewport = document.createElement("div"), o = this.elements.img = document.createElement("img"), a = this.elements.overlay = document.createElement("div"), this.options.useCanvas ? (this.elements.canvas = document.createElement("canvas"), this.elements.preview = this.elements.canvas) : this.elements.preview = o, d(e, "cr-boundary"), e.setAttribute("aria-dropeffect", "none"), s = this.options.boundary.width, l = this.options.boundary.height, p(e, {
                            width: s + (isNaN(s) ? "" : "px"),
                            height: l + (isNaN(l) ? "" : "px")
                        }), d(r, "cr-viewport"), h && d(r, h), p(r, {
                            width: this.options.viewport.width + "px",
                            height: this.options.viewport.height + "px"
                        }), r.setAttribute("tabindex", 0), d(this.elements.preview, "cr-image"), m(this.elements.preview, {
                            alt: "preview",
                            "aria-grabbed": "false"
                        }), d(a, "cr-overlay"), this.element.appendChild(e), e.appendChild(this.elements.preview), e.appendChild(r), e.appendChild(a), d(this.element, "croppie-container"), this.options.customClass && d(this.element, this.options.customClass),
                        function() {
                            ...
                            function m(n) {
                                ...
                                if ("touchmove" === n.type && n.touches.length > 1) {
                                    ...
                                    var y = w / o;
                                    return Z.call(s, y), void c(s.elements.zoomer)
                                }
                                h(d, m), f[i] = a.toString(), p(s.elements.preview, f), L.call(s), t = l, e = r
                            }

                            function f() {
                                u(l = !1), window.removeEventListener("mousemove", m), window.removeEventListener("touchmove", m), window.removeEventListener("mouseup", f), window.removeEventListener("touchend", f), document.body.style[n] = "", B.call(s), O.call(s), o = 0
                            }
                                        ...
                                        a = w.parse(s.elements.preview), document.body.style[n] = "none", r = s.elements.viewport.getBoundingClientRect(),
                                            function(e) {
                                                var t = e[0],
                                                    r = e[1],
                                                    l = {};
                                                h(t, r), l[i] = a.toString(), p(s.elements.preview, l), L.call(s), document.body.style[n] = "", B.call(s), O.call(s), o = 0
                                            }(d)
                                    }
                                } else {
                                    var m;
                            ...
                            var e = this,
                                n = e.elements.zoomerWrap = document.createElement("div"),
                                o = e.elements.zoomer = document.createElement("input");
                            ...
                            function a(t) {
                                ...
                                i = t.wheelDelta ? t.wheelDelta / 1200 : t.deltaY ? t.deltaY / 1060 : t.detail ? t.detail / -60 : 0, n = e._currentZoom + i * e._currentZoom, t.preventDefault(), Z.call(e, n), r.call(e)
                            }
                            d(n, "cr-slider-wrap"), d(o, "cr-slider"), o.type = "range", o.step = "0.0001", o.value = "1", o.style.display = e.options.showZoomer ? "" : "none", o.setAttribute("aria-label", "zoom"), e.element.appendChild(n), n.appendChild(o), e._currentZoom = 1, e.elements.zoomer.addEventListener("input", r), e.elements.zoomer.addEventListener("change", r), e.options.mouseWheelZoom && (e.elements.boundary.addEventListener("mousewheel", a), e.elements.boundary.addEventListener("DOMMouseScroll", a))
                            ...
                            function f(n) {
                                ...
                                })), L.call(l), X.call(l), B.call(l), O.call(l), i = s, t = a
                            }
                ...
                function B(e) {
                    var n = this._currentZoom,
                        ...
                        a = w.parse(this.elements.preview.style[i]),
                        s = new y(this.elements.preview),
                    ...
                    } else u.y = l / n, u.x = h / n, c.y = (u.y - s.y) * (1 - n), c.x = (u.x - s.x) * (1 - n), a.x -= c.x, a.y -= c.y;
                    var g = {};
                    g[t] = u.x + "px " + u.y + "px", g[i] = a.toString(), p(this.elements.preview, g)
                }
                ...
                var _, R, z, I, M = (_ = L, R = 500, function() {
                    var e = this,
                        t = arguments,
                        i = z && !I;
                    clearTimeout(I), I = setTimeout(function() {
                        I = null, z || _.apply(e, t)
                    }, R), i && _.apply(e, t)
                });
                ...
                function W() {
                    ...
                    F.call(this) && !this.data.bound && (this.data.bound = !0, n[i] = r.toString(), n[t] = a.toString(), n.opacity = 1, p(o, n), e = this.elements.preview.getBoundingClientRect(), this._originalImageWidth = e.width, this._originalImageHeight = e.height, this.data.orientation = b(this.elements.img), this.options.enableZoom ? X.call(this, !0) : this._currentZoom = 1, r.scale = this._currentZoom, n[i] = r.toString(), p(o, n), this.data.points.length ? function(e) {
                        ...
                        var n = e[2] - e[0],
                            ...
                            c = -1 * e[0] + a.left,
                            d = {};
                        d[t] = h + "px " + l + "px", d[i] = new w(c, u, s).toString(), p(this.elements.preview, d), Z.call(this, s), this._currentZoom = s
                    ...
                    }.call(this), B.call(this), L.call(this))
                }
                ...
                function X(e) {
                    ...
                    this.options.enforceBoundary && (n = p.width / u.width, o = p.height / u.height, r = Math.max(n, o)), r >= a && (a = r + 1), s.min = N(r, 4), s.max = N(a, 4), !e && (l < s.min || l > s.max) ? Z.call(this, l < s.min ? s.min : s.max) : e && (i = Math.max(h.width / u.width, h.height / u.height), t = null !== this.data.boundZoom ? this.data.boundZoom : i, Z.call(this, t)), c(s)
                }
                ...
                function j(e, t) {
                    ...
                    if ("string" == typeof e) i = e, e = {};
                        ...
                        if (void 0 === e && a.data.url) return W.call(a), O.call(a), null;
                        i = e.url, s = e.points || [], l = void 0 === e.zoom ? null : e.zoom
                    }
                    return a.data.bound = !1, a.data.url = i || a.data.url, a.data.boundZoom = l, (n = i, o = h, r = new Image, r.style.opacity = "0", new Promise(function(e, t) {
                        function i() {
                        ...
                        if (function(e) {
                            ...
                            }.call(a, i), s.length) a.options.relative && (s = [s[0] * i.naturalWidth / 100, s[1] * i.naturalHeight / 100, s[2] * i.naturalWidth / 100, s[3] * i.naturalHeight / 100]);
                        else {
                            var n, o, r = v(i),
                        ...
                        a.data.points = s.map(function(e) {
                            ...
                            var t = this.elements.canvas,
                                i = this.elements.img;
                            t.getContext("2d").clearRect(0, 0, t.width, t.height), t.width = i.width, t.height = i.height, x(t, i, this.options.enableOrientation && e || b(i))
                        }.call(a, e.orientation), W.call(a), O.call(a), t && t()
                    })
                }
                ...
                function P(e) {
                    ...
                    this.data.orientation = (t = this.data.orientation, i = e, n = a.indexOf(t) > -1 ? a : s, o = n.indexOf(t), r = i / 90 % n.length, n[(n.length + o + r % n.length) % n.length]), x(l, this.elements.img, this.data.orientation), B.call(this, !0), X.call(this)
                }
                if (window.jQuery) {
                    var T = window.jQuery;
                ...
                function D(e, t) {
                    ...
                    if (this.element = e, this.options = h(u(D.defaults), t), "img" === this.element.tagName.toLowerCase()) {
                        var i = this.element;
                    ...
                    if (C.call(this), this.options.url) {
                        ...
                        delete this.options.url, delete this.options.points, j.call(this, o)
                    }
                }
                return D.defaults = {
                    viewport: {
                    ...
                    setZoom: function(e) {
                        Z.call(this, e), c(this.elements.zoomer)
                    },
                    rotate: function(e) {
                        P.call(this, e)
                    },
            ...
            }, "string" != typeof i.nodeName ? e.exports = o() : n.Croppie = o()
        }(i = {
            exports: {}
        }, i.exports), i.exports),
        o = {
            ...
            methods: {
                initCroppie: function() {
                    ...
                    this.boundary && (i.boundary = this.boundary), t.addEventListener("update", function(t) {
                        e.$emit("update", t.detail)
                    }), this.croppie = new n(t, i), this.croppieInitialized()
                },
                bind: function(e) {
                    return this.croppie.bind(e)
                },
                destroy: function() {
                    this.croppie.destroy()
                },
                get: function(e) {
                    if (!e) return this.croppie.get();
                    e(this.croppie.get())
                },
                rotate: function(e) {
                    this.croppie.rotate(e)
                },
                setZoom: function(e) {
                ...
                result: function(e, t) {
                    ...
                    return e || (e = {
                        type: "base64"
                    }), this.croppie.result(e).then(function(e) {
                        return t ? t(e) : i.$emit("result", e), e
                    })
                },
                refresh: function() {
    ...
    window && window.Vue && Vue.use(r), e.default = r, e.VueCroppieComponent = o, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});
